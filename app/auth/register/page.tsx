      ...
      <div className="flex-1 flex items-start justify-center px-8 py-16 overflow-y-auto">
        <div className="w-full max-w-sm glass-panel rounded-[12px] p-6 md:p-7">
          ...
          <a
            ...
            className="w-full flex items-center justify-center gap-3 py-3 px-4 border-[0.5px] border-[var(--line)] rounded-[8px] text-[13px] font-[Jost] font-medium text-[var(--charcoal)] hover:border-[var(--forest)] hover:bg-[var(--paper-dark)] transition-all duration-200 mb-6"
          >
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <span className="text-[9px] uppercase tracking-[2px] text-[var(--grey-light)] font-[Jost] font-medium">or register with email</span>
            <div className="flex-1 h-[0.5px] bg-[var(--line)]"/>
          </div>
